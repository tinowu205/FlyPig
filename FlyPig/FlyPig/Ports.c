...
State initAirport(airport* airport){
    char* dest[] = {"北京","上海","深圳","广州","杭州","成都"};
    long int routesID[allRoutes] = {342,182,900,154,872,797};
    int planesID[allRoutes] = {19,29,33,11,16,82};
    char* date[] = {"周三","周一","周日","周六","周一","周二"};
    int capacity[allRoutes] = {400,420,350,300,320,280};
    int leftTickets[allRoutes] = {182,112,152,83,49,72};
